class Customer
  ...
  def email_address
    e = Hash.new
    e['email_address'] = @spree_customer['email']
    e['email_address_caps'] = @spree_customer['email'].upcase
    e
  end
  ...
  def sugar_account
    ...
    puts "sugar_account: #{account.inspect}"
    return account
  end
  ...
  def sugar_contact
    ...
    puts "sugar_contact: #{contact.inspect}"
    return contact
  end
